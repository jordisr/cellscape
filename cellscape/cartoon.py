...
class Cartoon:
    """A class for molecular outlines generated by Structure class"""
    ...
    def plot(self, colors=None, axes_labels=False, color_residues_by=None, edge_color="black", line_width=0.7,
        ...
        """Plot styled protein cartoon

        Color schemes for plotting can be specified in multiple ways
        ...
        By default, plot() creates a new matplotlib Axes instance, though one can be passed explicitly.
        This mirrors Biopython's phylogeny drawing https://biopython.org/DIST/docs/api/Bio.Phylo._utils-module.html.

        Args:
            colors (optional): Explicitly pass color scheme (see description). Defaults to None.
            axes_labels (bool, optional): Include axes labels on plot. Defaults to False.
            color_residues_by (str, optional): If outlining all residues, color based on attribute (e.g. "chain"). Defaults to None.
            edge_color (str, optional): Color for outline edges. Defaults to "black".
            line_width (float, optional): Width of outlines. Defaults to 0.7.
            depth_shading (bool, optional): Use lighter shades for outlines closer to the front. Defaults to False.
            depth_lines (bool, optional): Use lighter lines for outlines closer to the front. Defaults to False.
            shading_range (float, optional): Dynamic range for depth_shading effect. Defaults to 0.4.
            smoothing (bool, optional): Apply smoothing to polygons. Defaults to False.
            do_show (bool, optional): Whether to show figure (otherwise just returns Axes object). Defaults to True.
            axes (Axes, optional): Explicitly pass matplotlib Axes object. Defaults to None.
            save (str, optional): Path to save cartoon image. Defaults to None.
            dpi (int, optional): DPI of rasterized images. Defaults to 300.
            placeholder (float, optional): Specify expected protein height (in angstroms). Will add a placeholder shape to add up to total height. Defaults to None.

        Returns:
            Axes: Returns matplotlib Axes if do_show=False, otherwise return None
        """
